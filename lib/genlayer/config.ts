...
export const REQUIRED_METHODS = [
  ...
  "propose_resolution", "adjudicate_resolution", "get_archive", "get_record",
  "get_case", "get_cluster", "is_curator", "get_record_cluster",
  ...
  "adjudicate_correction", "get_correction", "list_correction_ids", "list_cluster_correction_ids", "stats",
] as const;
